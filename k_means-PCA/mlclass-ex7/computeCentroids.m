...
%%% for every element of popK assign his n values in the dataset to the empty matrix
...
%%%for every dim/column of the populated matrix, get the mean of that column a new coordonate of centroid this centroid
